 ...
 * Using a long for storing money values
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //In the case above the error won't matter, but if we were adding thousands of numbers then
        ...
        long threeCoffees = coffeeCost + coffeeCost + coffeeCost;  // there can't be any rounding errors when using integer values
        System.out.println("Three Coffees cost = " + String.format("%6.2f", (double) threeCoffees / 100) + " euro");

        // BigDecimal
        // For really massive numbers we can use the BigDecimal object type
